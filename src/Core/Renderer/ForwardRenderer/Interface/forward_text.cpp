#include "forward_text.h"

ForwardText::ForwardText(Text * text) : ForwardDrawable(static_cast<Drawable*>(text)) {
    setup();
}

void ForwardText::update() {
...
void ForwardText::dispose() {

}

void ForwardText::setup() {
