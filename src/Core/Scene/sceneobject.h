...
public:
   ...
   *
   * The current node where this function has been called will be the root node
   * for this operation
   *
   ...
   */
  void addUpdateListener(void *receiver,
   ...
   */
  void
  addUpdateTreeListener(void *receiver,
                        std::function<void(SceneObject *)> receiverFunction);
...
private:
  ...
  std::vector<std::pair<void *, std::function<void(SceneObject *)>>>
      updateTreeListeners;
